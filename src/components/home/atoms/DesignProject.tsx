    ...
    <div className="w-full">
      <div className={cn("")}>
        <div className="flex h-8 ">
          <div className="w-40 p-2 pl-6 bg-neutral-700 rounded-t-xl">
            Design
          </div>
          <div className="-ml-10 rounded-tr-md w-20 skew-x-[50deg] bg-neutral-700"></div>
        </div>
        <div className="h-[350px] flex items-start justify-between gap-8 rounded-2xl rounded-tl-none w-[850px] p-6 bg-neutral-700">
          <div>
